...
import type { EventInput, ViewType, ICalendarEvent, EventSourceRawInput, ICalendarPlugin, DropPayload, BusinessHours, ResourceInput } from '@nexa-calendar/core'
...
export interface NxCalendarProps {
  ...
  onEventDrop?: (e: CustomEvent<{ event: ICalendarEvent; oldStart: string; newStart: string }>) => void
  onEventResize?: (e: CustomEvent<{ event: ICalendarEvent; oldEnd?: string; newEnd: string }>) => void
