        ...
        <div style="display: flex; align-items: center; gap: 4px;">
          <button
            ...
            @mouseleave=${(e: MouseEvent) =>
              ((e.currentTarget as HTMLElement).style.background = 'var(--nx-surface-alt)')}
          ...
          <button
            ...
            @mouseenter=${(e: MouseEvent) =>
              ((e.currentTarget as HTMLElement).style.background = 'var(--nx-accent-hover)')}
            @mouseleave=${(e: MouseEvent) =>
              ((e.currentTarget as HTMLElement).style.background = 'var(--nx-accent)')}
        ...
        >
          ${availableViews.map(v => {
            ...
            return html` <button
              ...
              @mouseenter=${(e: MouseEvent) => {
                if (!isActive) (e.currentTarget as HTMLElement).style.color = 'var(--nx-text)';
              }}
              @mouseleave=${(e: MouseEvent) => {
                if (!isActive)
                  (e.currentTarget as HTMLElement).style.color = 'var(--nx-text-muted)';
              }}
