...
let NxToolbar = class NxToolbar extends LitElement {
    constructor() {
        ...
        this.views = ['month', 'workWeek', 'week', 'day', 'list', 'timeline', 'timelineWeek', 'timelineMonth'];
    ...
    render() {
        ...
        const allViews = ['month', 'workWeek', 'week', 'day', 'list', 'timeline', 'timelineDay', 'timelineWeek', 'timelineMonth', 'year'];
          ...
          ${availableViews.map(v => {
            ...
            return html `
              <button
                ...
                @mouseenter=${(e) => { if (!isActive)
                e.currentTarget.style.color = 'var(--nx-text)'; }}
                @mouseleave=${(e) => { if (!isActive)
...
], NxToolbar.prototype, "title", void 0);
__decorate([
    property({ type: String }),
    __metadata("design:type", String)
], NxToolbar.prototype, "view", void 0);
__decorate([
    property({ type: Object }),
    __metadata("design:type", Object)
], NxToolbar.prototype, "locale", void 0);
__decorate([
    property({ type: Array }),
    __metadata("design:type", Array)
], NxToolbar.prototype, "views", void 0);
NxToolbar = __decorate([
