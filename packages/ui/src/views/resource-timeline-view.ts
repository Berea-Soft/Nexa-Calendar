...
import type { ResourceTimelineGrid, ResourceTimelineRow, ICalendarEvent, Locale } from '@nexa-calendar/core'
...
export class NxResourceTimelineView extends LitElement {
  ...
  private _renderRow(row: ResourceTimelineRow, columns: ResourceTimelineGrid['columns'], totalTimeWidth: number) {
  ...
  private _dateClick(date: import('@bereasoftware/time-guard').TimeGuard, row: ResourceTimelineRow) {
