...
let NxCalendar = class NxCalendar extends LitElement {
  ...
  set resources(value) {
    if (value) this._resources = value.map(r => ({ ...r, children: r.children ?? [] }));
  }
  set view(value) {
...
__decorate([state(), __metadata('design:type', Object)], NxCalendar.prototype, '_state', void 0);
__decorate([state(), __metadata('design:type', Object)], NxCalendar.prototype, '_grid', void 0);
__decorate([state(), __metadata('design:type', Array)], NxCalendar.prototype, '_resources', void 0);
__decorate(
  [state(), __metadata('design:type', Object)],
  NxCalendar.prototype,
  '_selectionRange',
  void 0
);
__decorate(
...
__decorate(
  [property({ type: [Number, Boolean] }), __metadata('design:type', Object)],
  NxCalendar.prototype,
  'dayMaxEvents',
  void 0
);
...
NxCalendar = __decorate([customElement('nx-calendar')], NxCalendar);
export { NxCalendar };
