...
export class CalendarStore {
  ...
  get navigator(): INavigable { return this._navigator }
  get eventManager(): EventManager { return this._eventManager }
  get views(): ViewManager { return this._viewManager }
  get selection(): SelectionManager { return this._selectionManager }
  get plugins(): PluginManager { return this._pluginManager }
  get validator(): EventValidator { return this._eventValidator }
  get sorter(): EventSorter { return this._eventSorter }
  ...
  selectDate(start: import('@bereasoftware/time-guard').TimeGuard, end: import('@bereasoftware/time-guard').TimeGuard): void {
  ...
  getEventsInRange(start: import('@bereasoftware/time-guard').TimeGuard, end: import('@bereasoftware/time-guard').TimeGuard): ICalendarEvent[] {
