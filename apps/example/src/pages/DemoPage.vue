...
const bizHours = computed(() => {
  ...
  if (example.value === 'full' && showBizHours.value && bizConfig.value !== 'default' && bizConfig.value !== 'custom') {
...
<style scoped>
.demo-page { display: flex; min-height: 100vh; }
.app-main { flex: 1; padding: 24px; min-width: 0; overflow: auto; }
</style>