...
export const EXAMPLES: ExampleDef[] = [
  {
    key: 'full',
    title: 'Full Features',
    desc: 'All events, business hours, DnD, i18n',
    icon: '🎯',
  },
  { key: 'business', title: 'Business Hours', desc: '9AM–6PM Mon–Fri, work week view', icon: '💼' },
  {
    key: 'minimal',
    title: 'Minimal / Read-only',
    desc: 'Plain calendar, no drag, no limits',
    icon: '📋',
  },
  { key: 'noweekends', title: 'No Weekends', desc: 'Mon–Fri only, non-current hidden', icon: '📅' },
  {
    key: 'eventlimit',
    title: 'Event Limit (3)',
    desc: 'Max 3 per day, "more" popover',
    icon: '📊',
  },
  {
    key: 'timeline',
    title: 'Timeline View',
    desc: 'Horizontal event bars across days',
    icon: '📈',
  },
  {
    key: 'resource-timeline',
    title: 'Resource Timeline',
    desc: 'Per-resource rows, frozen column',
    icon: '👥',
  },
  ...
  { key: 'drag-drop', title: 'Drag & Drop', desc: 'Move and resize events', icon: '✋' },
  {
    ...
    desc: 'Events shown as bars behind',
    icon: '🎨',
  },
  {
    key: 'selectable',
    title: 'Selectable Dates',
    desc: 'Click dates to create events',
    icon: '🖱️',
  },
...
export const BASE_EVENTS = [
  ...
  },
  {
    id: 4,
    title: 'Team Lunch',
    start: fmt(new Date(today.getFullYear(), today.getMonth() + 1, 5, 12)),
...
export const TIMEZONE_EVENTS_UTC = [
  {
    ...
    start: fmtUtc(today, 14),
    end: fmtUtc(today, 14, 30),
    backgroundColor: '#3b82f6',
  },
  {
    id: 'tz-2',
